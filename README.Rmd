...
[![Travis-CI Build Status](https://travis-ci.org/jameelalsalam/tidygraph.svg?branch=master)](https://travis-ci.org/jameelalsalam/tidygraph)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/jameelalsalam/tidygraph?branch=master&svg=true)](https://ci.appveyor.com/project/jameelalsalam/tidygraph)
